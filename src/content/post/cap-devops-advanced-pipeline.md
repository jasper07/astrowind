...
title: SAP CAP and Azure DevOps
excerpt: Discover how to automate CAP deployments on BTP Cloud Foundry using Azure DevOps pipelines. Originally presented at SAP Devtoberfest 2023, this comprehensive guide walks through both simple and advanced pipeline configurations, using a real-world scenario to demonstrate enterprise-grade deployment strategies. Complete with working examples and detailed explanations.
image: ~/assets/images/advanced-pipeline.png
...
This article shares the advanced Azure DevOps pipeline configuration from my SAP Devtoberfest 2023 presentation [SAP CAP in Flight: BTP Cloud Foundry Automated Deployments with Azure DevOps](https://www.youtube.com/watch?v=lfWhp7Cyx0A). The complete code samples and documentation can be found in the GitHub repository [cap-sflight-devops](https://github.com/jasper07/cap-sflight-devops/tree/main).
...
![Advanced Pipeline](https://raw.githubusercontent.com/jasper07/cap-sflight-devops/refs/heads/main/azure-pipelines/docs/advanced-pipeline.png)

[azure-pipelines-advanced.yml](https://github.com/jasper07/cap-sflight-devops/blob/main/azure-pipelines/azure-pipelines-advanced.yml)

![Advanced Pipeline Running](https://raw.githubusercontent.com/jasper07/cap-sflight-devops/refs/heads/main/azure-pipelines/docs/advanced-pipeline-running.png)
...
![reuse github actions for Build stage](https://raw.githubusercontent.com/jasper07/cap-sflight-devops/refs/heads/main/azure-pipelines/docs/advanced-pipeline-build-reuse.png)  
...
![Unit Test Results](https://raw.githubusercontent.com/jasper07/cap-sflight-devops/refs/heads/main/azure-pipelines/docs/advanced-pipeline-tests-result.png)
...
![Code Coverage Results](https://raw.githubusercontent.com/jasper07/cap-sflight-devops/refs/heads/main/azure-pipelines/docs/advanced-pipeline-coverage-result.png)
...
![Integration Tests Results](https://raw.githubusercontent.com/jasper07/cap-sflight-devops/refs/heads/main/azure-pipelines/docs/advanced-pipeline-results-integration.png)  
...
![advanced-pipeline-library-variable-groups.png](https://raw.githubusercontent.com/jasper07/cap-sflight-devops/refs/heads/main/azure-pipelines/docs/advanced-pipeline-library-variable-groups.png)
...
The Scan task is in a template found at [azure-pipelines/templates/steps/snykSecurityScan.yml](https://github.com/jasper07/cap-sflight-devops/blob/main/azure-pipelines/templates/steps/snykSecurityScan.yml)
```yaml
...
![advanced-pipeline-security-scan.png](https://raw.githubusercontent.com/jasper07/cap-sflight-devops/refs/heads/main/azure-pipelines/docs/advanced-pipeline-security-settings.png)  
Register a service connection in the Project Settings and give it the Snyk API token you created.

![advanced-pipeline-security-scan.png](https://raw.githubusercontent.com/jasper07/cap-sflight-devops/refs/heads/main/azure-pipelines/docs/advanced-pipeline-security-scan.png)  
...
![wdi5Edge_Chrome.gif](https://raw.githubusercontent.com/jasper07/cap-sflight-devops/refs/heads/main/azure-pipelines/docs/WDI5_Workzone_Edge_Chrome.gif)  
Above shows the wdi5 tests running parallel both in Edge and Chrome browsers at same time.

To write wdi5 [test code](https://github.com/jasper07/cap-sflight-devops/blob/main/azure-pipelines/e2e/webapp/test/e2e/Journey.test.js) is very similar to how you write Opa5 integration test code.
```javascript
...
To run wdi5 call a script in the [package.json](/azure-pipelines/e2e/package.json), check the file [.env.template](https://raw.githubusercontent.com/jasper07/cap-sflight-devops/refs/heads/main/azure-pipelines/e2e/.env.template) for needed environment variables.
```json
   "scripts": {
...
![wdi5 test results](https://raw.githubusercontent.com/jasper07/cap-sflight-devops/refs/heads/main/azure-pipelines/docs/wdi5-test-results.png)
...
![browserstack-service-connection](https://raw.githubusercontent.com/jasper07/cap-sflight-devops/refs/heads/main/azure-pipelines/docs/browserstack-service-connection.png)

The instructions also guide you through using the two tasks they provide.  
**BrowserStackConfig@0** the configuration task, link to the service end point and provide the steps and environment variables necessary for running the [wdio.browserstack.conf.js](https://github.com/jasper07/cap-sflight-devops/blob/main/azure-pipelines/e2e/wdio.browserstack.conf.js) file.  
...
![browerstack-multiple-devices](https://raw.githubusercontent.com/jasper07/cap-sflight-devops/refs/heads/main/azure-pipelines/docs/browerstack-multiple-devices.png)
...
![browerstack-drill-in-report](https://raw.githubusercontent.com/jasper07/cap-sflight-devops/refs/heads/main/azure-pipelines/docs/browerstack-drill-in-report.png)
...
![k6 code](https://raw.githubusercontent.com/jasper07/cap-sflight-devops/refs/heads/main/azure-pipelines/docs/k6-code.png)  
...
![k6 Report](https://raw.githubusercontent.com/jasper07/cap-sflight-devops/refs/heads/main/azure-pipelines/docs/k6-report.png)   
...
![ctms-variables](https://raw.githubusercontent.com/jasper07/cap-sflight-devops/refs/heads/main/azure-pipelines/docs/advanced-pipeline-ctms-variables.PNG)  
...
![alt text](https://raw.githubusercontent.com/jasper07/cap-sflight-devops/refs/heads/main/azure-pipelines/docs/ctms_joblog.PNG "Title")
...
![alt text](https://raw.githubusercontent.com/jasper07/cap-sflight-devops/refs/heads/main/azure-pipelines/docs/ctms_qa_queue.PNG "Title")  
